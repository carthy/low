...
(def ^:private llvm-api
  [;; Context
   ...
   ;; [:AppendBasickBlock [:value :constchar*] :basic-block]
   ;; [:AppendBasickBlockInContext [:context :value :constchar*] :basic-block]
   ;; [:InsertBasickBlock [:basic-block :constchar*] :basic-block]
   ;; [:InsertBasickBlockInContext [:context :basic-block :constchar*] :basic-block]
   ...
   [:GetFirstInstruction [:basic-block] :value]
   [:GetLastInstruction [:basic-block] :value]
   ;; PassManager
