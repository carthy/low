...
(def ^:private llvm-api
  [;; Context
   ...
   [:CreateFunctionPassManagerForModule [ModuleRef] PassManagerRef #{3.0 3.1}]
   [:CreateFunctionPassManager [ModuleProviderRef] PassManagerRef #{3.0 3.1}]
   [:FinalizeFunctionPassManager [PassManagerRef] bool #{3.0 3.1}]
   [:DisposePassManager [PassManagerRef] Void #{3.0 3.1}]
   [:RunPassManager [PassManagerRef ModuleRef] bool #{3.0 3.1}]
   [:RunFunctionPassManager [PassManagerRef ValueRef] bool #{3.0 3.1}]
   ;; Passes
   [:AddInternalizePass [PassManagerRef Integer] Void #{3.0 3.1}]
   [:AddAlwaysInlinerPass [PassManagerRef] Void #{3.0 3.1}]
   ...
   [:AddScalarReplAggregatesPassWithThreshold [PassManagerRef Integer] Void #{3.0 3.1}]
   [:AddJumpThreadingPass [PassManagerRef] Void #{3.0 3.1}]
   [:AddIPConstantPropagationPass [PassManagerRef] Void #{3.0 3.1}]
   ...
   [:AddStripSymbolsPass [PassManagerRef] Void #{3.0 3.1}]
   ...
   [:AddPromoteMemoryToRegisterPass [PassManagerRef] Void #{3.0 3.1}]
   [:AddDemoteMemoryToRegisterPass [PassManagerRef] Void #{3.0 3.1}]
   [:AddLowerExpectIntrinsicPass [PassManagerRef] Void #{3.0 3.1}]
